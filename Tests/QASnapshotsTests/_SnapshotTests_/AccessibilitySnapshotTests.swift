...
@SnapshotSuite(includeAccessibility: true)
struct AccessibilitySnapshotTests {
    func test_Accessibility_InView() -> UIView {
        AccessibleView()
    }

    func test_Accessibility_InViewController() -> UIViewController {
        AccessibleViewController(accessibleView: AccessibleView())
    }

    func test_Accessibility_InSwiftUIView() -> some View {
