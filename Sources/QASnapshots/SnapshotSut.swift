...
public protocol SnapshotSut {
    /// Идентификатор, позволяющий установить идентичность двух `SnapshotSut`
    ///
    /// Нужен для ассерта на уникальность sut между вызовами замыкания в рамках одного ассерта
    var sutID: ObjectIdentifier { get }
}

extension UIView: SnapshotSut {
    public nonisolated var sutID: ObjectIdentifier { ObjectIdentifier(self) }
}
...
public struct SnapshotSutHolder: SnapshotSut {
    ...
    public var sutID: ObjectIdentifier { subject.sutID }
